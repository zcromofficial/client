    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
      ...
      <div className="text-center lg:text-left">
        ...
        <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed">
          We design systems that handle millions of users, process massive data
          volumes, and remain resilient under any load. Our architectures
          prioritize scalability, performance, security, and cost-efficiency
          from day one.
        </p>

        {/* Checklist - Centered block on mobile, text aligned left */}
      ...
      {/* Image Section with Floating Card */}
      <div className="relative mt-8 lg:mt-0 px-4 lg:px-0">
        ...
        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-[90%] lg:w-auto lg:left-[-2rem] lg:translate-x-0 bg-white p-4 lg:p-6 rounded-xl shadow-xl border border-gray-100">
          <div className="flex items-center gap-3 justify-center lg:justify-start">
            ...
            <div>
              <div className="text-xl lg:text-2xl font-bold whitespace-nowrap">Enterprise Grade</div>
              <div className="text-xs lg:text-sm text-gray-600">Battle-Tested</div>
            </div>
          </div>
        </div>
      </div>
